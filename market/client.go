...
func (c *Client) ProfileEdit(opts ...func(*ProfileEditParams)) (map[string]any, error) {
	...
	if p.Option != nil {
		body["option"] = *p.Option
	}
	if p.TelegramApiId != nil {
		body["telegram_api_id"] = *p.TelegramApiId
	}
	if p.TelegramDeviceModel != nil {
		body["telegram_device_model"] = *p.TelegramDeviceModel
	}
	if p.TelegramAppVersion != nil {
		body["telegram_app_version"] = *p.TelegramAppVersion
	}
	if p.TelegramSystemLangCode != nil {
		body["telegram_system_lang_code"] = *p.TelegramSystemLangCode
	}
	if p.ClearTelegramClient != nil {
		body["clear_telegram_client"] = *p.ClearTelegramClient
	}
	if p.AllowAcceptAccounts != nil {
		body["allow_accept_accounts"] = *p.AllowAcceptAccounts
	}
	if p.TelegramApiHash != nil {
		body["telegram_api_hash"] = *p.TelegramApiHash
	}
	if p.TelegramSystemVersion != nil {
		body["telegram_system_version"] = *p.TelegramSystemVersion
	}
	if p.TelegramLangPack != nil {
		body["telegram_lang_pack"] = *p.TelegramLangPack
	}
	if p.TelegramLangCode != nil {
		body["telegram_lang_code"] = *p.TelegramLangCode
	}
...
func (c *Client) PaymentsBalanceExchange(fromBalance string, toBalance string, amount int64, opts ...func(*PaymentsBalanceExchangeParams)) (map[string]any, error) {
	...
	body := map[string]any{}
	body["from_balance"] = fromBalance
	body["to_balance"] = toBalance
	body["amount"] = amount
...
func (c *Client) ManagingCreateClaim(postBody string, itemId int64, opts ...func(*ManagingCreateClaimParams)) (*ManagingCreateClaimResponse, error) {
...
func (c *Client) ManagingEdit(itemId int64, opts ...func(*ManagingEditParams)) (map[string]any, error) {
	...
	if p.ItemOrigin != nil {
		body["item_origin"] = *p.ItemOrigin
	}
	if p.AllowAskDiscount != nil {
		body["allow_ask_discount"] = *p.AllowAskDiscount
	}
	...
	if p.EmailLoginData != nil {
		body["email_login_data"] = *p.EmailLoginData
	}
	if p.EmailType != nil {
		body["email_type"] = *p.EmailType
	}
	if p.ProxyId != nil {
		body["proxy_id"] = *p.ProxyId
	}
	if p.Information != nil {
		body["information"] = *p.Information
	}
...
func (c *Client) PublishingFastSell(categoryId int64, currency string, itemOrigin string, price float64, opts ...func(*PublishingFastSellParams)) (*PublishingFastSellResponse, error) {
	...
	if p.RandomProxy != nil {
		body["random_proxy"] = *p.RandomProxy
	}
	if p.Description != nil {
		body["description"] = *p.Description
	}
	...
	body["item_origin"] = itemOrigin
	if p.LoginPassword != nil {
		body["login_password"] = *p.LoginPassword
	}
	if p.TitleEn != nil {
		body["title_en"] = *p.TitleEn
	}
	if p.ExtendedGuarantee != nil {
		body["extended_guarantee"] = *p.ExtendedGuarantee
	}
	if p.AllowAskDiscount != nil {
		body["allow_ask_discount"] = *p.AllowAskDiscount
	}
	...
	if p.HasEmailLoginData != nil {
		body["has_email_login_data"] = *p.HasEmailLoginData
	}
	if p.EmailType != nil {
		body["email_type"] = *p.EmailType
	}
...
func (c *Client) ManagingBulkGet(opts ...func(*ManagingBulkGetParams)) (*ManagingBulkGetResponse, error) {
	...
	if p.ParseSameItemIds != nil {
		body["parse_same_item_ids"] = *p.ParseSameItemIds
	}
...
func (c *Client) PublishingCheck(itemId int64, opts ...func(*PublishingCheckParams)) (map[string]any, error) {
	...
	if p.ResellItemId != nil {
		body["resell_item_id"] = *p.ResellItemId
	}
	if p.EmailType != nil {
		body["email_type"] = *p.EmailType
	}
...
func (c *Client) PaymentsTransfer(amount int64, currency string, opts ...func(*PaymentsTransferParams)) (map[string]any, error) {
	...
	if p.TelegramDeal != nil {
		body["telegram_deal"] = *p.TelegramDeal
	}
	if p.TelegramUsername != nil {
		body["telegram_username"] = *p.TelegramUsername
	}
	if p.TransferHold != nil {
		body["transfer_hold"] = *p.TransferHold
	}
	if p.HoldLengthValue != nil {
		body["hold_length_value"] = *p.HoldLengthValue
	}
	body["amount"] = amount
	body["currency"] = currency
	if p.Comment != nil {
	...
	if p.HoldLengthOption != nil {
		body["hold_length_option"] = *p.HoldLengthOption
	}
...
func (c *Client) AutoPaymentsCreate(amount float64, usernameReceiver string, day int64, opts ...func(*AutoPaymentsCreateParams)) (*AutoPaymentsCreateResponse, error) {
	...
	body["username_receiver"] = usernameReceiver
	body["day"] = day
...
func (c *Client) AutoPaymentsDelete(autoPaymentId int64, opts ...func(*AutoPaymentsDeleteParams)) (map[string]any, error) {
	...
	body := map[string]any{}
	body["auto_payment_id"] = autoPaymentId
...
func (c *Client) PaymentsPayout(currency string, paymentSystem string, wallet string, amount float64, opts ...func(*PaymentsPayoutParams)) (map[string]any, error) {
	...
	body["currency"] = currency
	if p.IncludeFee != nil {
		body["include_fee"] = *p.IncludeFee
	}
	if p.Extra != nil {
		body["extra"] = *p.Extra
	}
	body["payment_system"] = paymentSystem
	body["wallet"] = wallet
	body["amount"] = amount
...
func (c *Client) CustomDiscountsCreate(minPrice float64, userId int64, categoryId int64, discountPercent float64, opts ...func(*CustomDiscountsCreateParams)) (*CustomDiscountsCreateResponse, error) {
...
func (c *Client) CustomDiscountsEdit(discountId int64, opts ...func(*CustomDiscountsEditParams)) (*CustomDiscountsEditResponse, error) {
	...
	if p.DiscountPercent != nil {
		body["discount_percent"] = *p.DiscountPercent
	}
	if p.MinPrice != nil {
		body["min_price"] = *p.MinPrice
	}
...
func (c *Client) PaymentsInvoiceCreate(amount float64, urlSuccess string, merchantId int64, currency string, paymentId string, comment string, opts ...func(*PaymentsInvoiceCreateParams)) (*PaymentsInvoiceCreateResponse, error) {
	...
	if p.UrlCallback != nil {
		body["url_callback"] = *p.UrlCallback
	}
	body["merchant_id"] = merchantId
	if p.Lifetime != nil {
		body["lifetime"] = *p.Lifetime
	}
	body["currency"] = currency
	body["payment_id"] = paymentId
	body["comment"] = comment
	if p.RequiredTelegramId != nil {
		body["required_telegram_id"] = *p.RequiredTelegramId
	}
	if p.RequiredTelegramUsername != nil {
		body["required_telegram_username"] = *p.RequiredTelegramUsername
	}
	if p.AdditionalData != nil {
		body["additional_data"] = *p.AdditionalData
	}
	if p.IsTest != nil {
		body["is_test"] = *p.IsTest
	}
...
func (c *Client) PublishingAdd(itemOrigin string, currency string, price float64, categoryId int64, opts ...func(*PublishingAddParams)) (*PublishingAddResponse, error) {
	...
	if p.ForceTempEmail != nil {
		body["forceTempEmail"] = *p.ForceTempEmail
	}
	if p.EmailLoginData != nil {
		body["email_login_data"] = *p.EmailLoginData
	}
...
func (c *Client) ManagingDeclineVideoRecording(itemId int64, iVoluntarilyAndWithFullAwarenessOfMyActionsWaiveAnyClaimsRegardingThisItem bool, opts ...func(*ManagingDeclineVideoRecordingParams)) (map[string]any, error) {
	...
	body := map[string]any{}
	body["i_voluntarily_and_with_full_awareness_of_my_actions_waive_any_claims_regarding_this_item"] = iVoluntarilyAndWithFullAwarenessOfMyActionsWaiveAnyClaimsRegardingThisItem
...
func (c *Client) ProxyAdd(opts ...func(*ProxyAddParams)) (map[string]any, error) {
	...
	body := map[string]any{}
	if p.ProxyPass != nil {
		body["proxy_pass"] = *p.ProxyPass
	}
	if p.ProxyRow != nil {
		body["proxy_row"] = *p.ProxyRow
	}
	if p.ProxyIp != nil {
		body["proxy_ip"] = *p.ProxyIp
	}
	if p.ProxyPort != nil {
		body["proxy_port"] = *p.ProxyPort
	}
	if p.ProxyUser != nil {
		body["proxy_user"] = *p.ProxyUser
	}
